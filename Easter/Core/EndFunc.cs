...
namespace Easter.Core
{
    public static class EndFunc
    {
        ...
        private static void LoadAssets(App app, EndMenu menu)
        {
            ...
            menu.Score = CreateTexture(app.Renderer, TTF_RenderText_Blended(font, app.Points.ToString(), color));
            ...
            menu.ScoreP = CreateTexture(app.Renderer, TTF_RenderText_Blended(font, "p", color));
            ...
            {
                menu.EggsScore.Add(CreateTexture(app.Renderer, TTF_RenderText_Blended(smallFont, app.EggCounts[e].ToString(), color)));
