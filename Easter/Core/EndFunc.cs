...
namespace Easter.Core
{
    public static class EndFunc
    {
        ...
        {
            // Score
            menu.Score = CreateTexture(app.Renderer, TTF_RenderText_Blended(BigFont, app.Points.ToString(), White));
            ...
            // Score P
            menu.ScoreP = CreateTexture(app.Renderer, TTF_RenderText_Blended(BigFont, "p", Lightblue));
